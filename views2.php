...
while($total--){
	...
	$selSqlP="SELECT `d_afdy_mony`,`clos_chck` FROM `toto_closedsale` where `reg_date`='".$foredate."'";
...
// 피부과 통장
	...
	$bank_info='<br /><br /><table cellpadding="0" cellspacing="0" border="1">
					<tr>
						<td width="100" class="style2">
						</td>
						<td width="100" class="style2">전일이월</td>
