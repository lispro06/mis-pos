        ...
        onSelect: function (dateText, inst) {
            ...
            if (sEndDate.length>0) {
                ...
                if (iStartDate>iCurDate) {
					...
					xajax_parent(xajax.$('exps_code').value, xajax.$('date_start').value);
				}
            }
        }
    });
...
<div class="exterior">
	<div class="tabA">
		...
		<input type="text" name="date_start" id="date_start" style="text-align:center;width:70px;" readonly />
...
<script>
		window.onload = function() {
			xajax_parent('<?php echo $_GET["exps_code"];?>','<?php echo $setTime;?>');
		}
</script>
</body>
</html>